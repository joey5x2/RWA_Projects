...
def compare_ead_cached(df_old, df_new):
    ...
    for col in ["Replacement_Cost","PFE_addon","multiplier","EAD"]:
...
def ai_agent(code_text, driver_summary, ead_deltas, csa_difference, trade_difference, CSA_inputs, llm_model):
...
if file_old and file_new:
    with st.spinner("Processing data..."):
        ...
        if st.session_state.agent is None:
            st.session_state.agent = ai_agent(code_text, driver_summary, ead_deltas, csa_difference, trade_difference, CSA_inputs, llm_model)
