...
def ai_agent(code_text, driver_summary, ead_deltas, csa_difference, trade_difference, llm_model):
...
if file_old and file_new:
    with st.spinner("Processing data..."):
        ...
        if st.session_state.agent is None:
            st.session_state.agent = ai_agent(code_text, driver_summary, ead_deltas, csa_difference, trade_difference, llm_model)
